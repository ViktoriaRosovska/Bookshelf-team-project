function e(e,t,o,n){Object.defineProperty(e,t,{get:o,set:n,enumerable:!0,configurable:!0})}function t(e){return e&&e.__esModule?e.default:e}var o="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:"undefined"!=typeof window?window:"undefined"!=typeof global?global:{},n={},a={},i=o.parcelRequire9432;null==i&&((i=function(e){if(e in n)return n[e].exports;if(e in a){var t=a[e];delete a[e];var o={id:e,exports:{}};return n[e]=o,t.call(o.exports,o,o.exports),o.exports}var i=Error("Cannot find module '"+e+"'");throw i.code="MODULE_NOT_FOUND",i}).register=function(e,t){a[e]=t},o.parcelRequire9432=i),i.register("4SSe9",function(t,o){"use strict";e(t.exports,"register",function(){return n},function(e){return n=e}),e(t.exports,"resolve",function(){return a},function(e){return a=e});var n,a,i={};n=function(e){for(var t=Object.keys(e),o=0;o<t.length;o++)i[t[o]]=e[t[o]]},a=function(e){var t=i[e];if(null==t)throw Error("Could not resolve bundle with id "+e);return t}}),i("4SSe9").register(JSON.parse('{"3z9Oy":"group.f68584a0.js","8OaUg":"amazon-icon1x.985b1de5.png","4MGAN":"amazon-icon2x.b774c146.png","gBscj":"applebook-icon1x.a9f158e0.png","7OUVG":"applebook-icon2x.7ba433f7.png","2qXmr":"bookshop-icon1x.95f5821d.png","iTw7C":"bookshop-icon2x.2b4b4a60.png","g8Z7h":"group.dfd703e7.js"}')),i("j2GOd"),i("lyquk"),i("clbZJ");var l=(i("j2GOd"),i("j2GOd"));const s=document.querySelector(".books-gallery"),r=new l.APIService;async function c(e){var t;let o;let n=await r.fetchBooksByCategory(e),a=await n.data;s.innerHTML=`<h1 class="collection-title">${(o=e.split(" ")).pop(),o.join(" ")} <span>${(t=e.trim().split(" "))[t.length-1]}</span></h1>
  ...
  `;B.innerHTML=d}(o),o}catch(e){(0,u.Loading).remove("Loading..."),console.log("Error",e),(0,d.reportsFailure)("Sorry, no books were found. Please try again.")}}async function J(e){try{F={};let t=await U.fetchBookInfo(e),o=t.data;return F={book_image:o.book_image,title:o.title,author:o.author,marketAmazon:o.buy_links[0].url,marketAppleBooks:o.buy_links[1].url,marketBookshop:o.buy_links[4].url,list_name:o.list_name,id:o._id,description:o.description},o}catch(e){console.log("Error",e)}}function Y(){let e=(0,$.isAuthenticated)()?JSON.parse(localStorage.getItem(N)):null,t=F.id;if(e&&0!==e.length){let o=e.find(e=>e.id===t);o?(j.style.display="none",R.style.display="block"):(j.style.display="block",null==R||(R.style.display="none"))}else{j.style.display="block",R.style.display="none";return}}const z=document.querySelector(".card-backdrop-modal"),V=document.querySelector(".modal"),Z=document.getElementById("modal-close");function W(){var e;null==z||z.classList.add("is-hidden"),null==V||V.classList.add("is-hidden"),null===(e=document.body)||void 0===e||e.classList.remove("modal-open"),document.removeEventListener("keydown",K),document.body.style.overflow="",_.show()}function K(e){"Escape"===e.code&&W()}V&&(null==z||z.addEventListener("click",function(e){e.target===z&&W()}),null==Z||Z.addEventListener("click",function(){W()}),window.addEventListener("keydown",K)),i("cZaO3"),i("cswOA"),i("aympR"),i("d0qiv"),i("ipb79"),i("7t6q4"),i("bWpVP");
//# sourceMappingURL=group.f68584a0.js.map
