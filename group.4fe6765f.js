function e(e,o,t,n){Object.defineProperty(e,o,{get:t,set:n,enumerable:!0,configurable:!0})}function o(e){return e&&e.__esModule?e.default:e}var t="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:"undefined"!=typeof window?window:"undefined"!=typeof global?global:{},n={},a={},i=t.parcelRequire9432;null==i&&((i=function(e){if(e in n)return n[e].exports;if(e in a){var o=a[e];delete a[e];var t={id:e,exports:{}};return n[e]=t,o.call(t.exports,t,t.exports),t.exports}var i=Error("Cannot find module '"+e+"'");throw i.code="MODULE_NOT_FOUND",i}).register=function(e,o){a[e]=o},t.parcelRequire9432=i),i.register("kyEFX",function(o,t){"use strict";e(o.exports,"register",function(){return n},function(e){return n=e}),e(o.exports,"resolve",function(){return a},function(e){return a=e});var n,a,i={};n=function(e){for(var o=Object.keys(e),t=0;t<o.length;t++)i[o[t]]=e[o[t]]},a=function(e){var o=i[e];if(null==o)throw Error("Could not resolve bundle with id "+e);return o}}),i("kyEFX").register(JSON.parse('{"5ZPII":"group.4fe6765f.js","kRCxU":"amazon-icon1x.985b1de5.png","45Fu3":"amazon-icon2x.b774c146.png","3SUJU":"applebook-icon1x.a9f158e0.png","igZ6H":"applebook-icon2x.7ba433f7.png","YfQvy":"bookshop-icon1x.95f5821d.png","5pNEw":"bookshop-icon2x.2b4b4a60.png","1upww":"group.9090f4c7.js","bamw1":"group.a1f89587.js"}')),i("3L4y6"),i("bUb57"),i("4R95q");var l=(i("3L4y6"),i("3L4y6"));const s=document.querySelector(".books-gallery"),r=new l.APIService;async function c(e){var o;let t;let n=await r.fetchBooksByCategory(e);console.log(n);let a=await n.data;console.log(a),s.innerHTML=`<h1 class="collection-title">${(t=e.split(" ")).pop(),t.join(" ")} <span>${(o=e.trim().split(" "))[o.length-1]}</span></h1>
  ...
  `;R.innerHTML=d}(t),t}catch(e){(0,u.Loading).remove("Loading..."),console.log("Error",e),(0,d.reportsFailure)("Sorry, no books were found. Please try again.")}}async function X(e){try{O={};let o=await j.fetchBookInfo(e),t=o.data;return O={book_image:t.book_image,title:t.title,author:t.author,marketAmazon:t.buy_links[0].url,marketAppleBooks:t.buy_links[1].url,marketBookshop:t.buy_links[4].url,list_name:t.list_name,id:t._id,description:t.description},t}catch(e){console.log("Error",e)}}function J(){let e=(0,$.isAuthenticated)()?JSON.parse(localStorage.getItem(C)):null,o=O.id;if(e&&0!==e.length){let t=e.find(e=>e.id===o);t?(F.style.display="none",U.style.display="block"):(F.style.display="block",(U?.style).display="none")}else{F.style.display="block",U.style.display="none";return}}const W=document.querySelector(".card-backdrop-modal"),Z=document.querySelector(".modal"),z=document.getElementById("modal-close");function D(){W?.classList.add("is-hidden"),Z?.classList.add("is-hidden"),document.body?.classList.remove("modal-open"),document.removeEventListener("keydown",Q),document.body.style.overflow="",_.show()}function Q(e){"Escape"===e.code&&D()}Z&&(W?.addEventListener("click",function(e){e.target===W&&D()}),z?.addEventListener("click",function(){D()}),window.addEventListener("keydown",Q)),i("hZAS5"),i("bMp0K"),i("4Z4PC"),i("fPeBo"),i("bXRWl"),i("bMZn5"),i("7uG5A");
//# sourceMappingURL=group.4fe6765f.js.map
