function e(e,t,o,n){Object.defineProperty(e,t,{get:o,set:n,enumerable:!0,configurable:!0})}function t(e){return e&&e.__esModule?e.default:e}var o="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:"undefined"!=typeof window?window:"undefined"!=typeof global?global:{},n={},l={},a=o.parcelRequire9432;null==a&&((a=function(e){if(e in n)return n[e].exports;if(e in l){var t=l[e];delete l[e];var o={id:e,exports:{}};return n[e]=o,t.call(o.exports,o,o.exports),o.exports}var a=Error("Cannot find module '"+e+"'");throw a.code="MODULE_NOT_FOUND",a}).register=function(e,t){l[e]=t},o.parcelRequire9432=a),a.register("kyEFX",function(t,o){"use strict";e(t.exports,"register",function(){return n},function(e){return n=e}),e(t.exports,"resolve",function(){return l},function(e){return l=e});var n,l,a={};n=function(e){for(var t=Object.keys(e),o=0;o<t.length;o++)a[t[o]]=e[t[o]]},l=function(e){var t=a[e];if(null==t)throw Error("Could not resolve bundle with id "+e);return t}}),a("kyEFX").register(JSON.parse('{"5ZPII":"group.c469c6c7.js","kRCxU":"amazon-icon1x.985b1de5.png","45Fu3":"amazon-icon2x.b774c146.png","3SUJU":"applebook-icon1x.a9f158e0.png","igZ6H":"applebook-icon2x.7ba433f7.png","YfQvy":"bookshop-icon1x.95f5821d.png","5pNEw":"bookshop-icon2x.2b4b4a60.png","4bpKV":"group.e0ce8c00.js","gKsO6":"group.48f7df64.js"}')),a("3L4y6"),a("bUb57"),a("4R95q");var i=(a("3L4y6"),a("3L4y6"));const s=document.querySelector(".books-gallery"),r=new i.APIService;async function c(e){var t;let o;let n=await r.fetchBooksByCategory(e);console.log(n);let l=await n.data;console.log(l),s.innerHTML=`<h1 class="collection-title">${(o=e.split(" ")).pop(),o.join(" ")} <span>${(t=e.trim().split(" "))[t.length-1]}</span></h1>
  ...
  `;H.innerHTML=d}(o),o}catch(e){console.log("Error",e)}}async function O(e){try{N={};let t=await U.fetchBookInfo(e),o=t.data;return N={book_image:o.book_image,title:o.title,author:o.author,marketAmazon:o.buy_links[0].url,marketAppleBooks:o.buy_links[1].url,marketBookshop:o.buy_links[4].url,list_name:o.list_name,id:o._id,description:o.description},o}catch(e){console.log("Error",e)}}function M(){let e=JSON.parse(localStorage.getItem(R)),t=N.id;if(e&&0!==e.length){let o=e.find(e=>e.id===t);o?(B.style.display="none",I.style.display="block"):(B.style.display="block",(I?.style).display="none")}else{B.style.display="block",I.style.display="none";return}}const J=document.querySelector(".card-backdrop-modal"),X=document.querySelector(".modal"),P=document.getElementById("modal-close");function K(){J?.classList.add("is-hidden"),X?.classList.add("is-hidden"),document.body?.classList.remove("modal-open"),document.removeEventListener("keydown",Z),document.body.style.overflow=""}function Z(e){"Escape"===e.code&&K()}X&&(J?.addEventListener("click",function(e){e.target===J&&K()}),P?.addEventListener("click",function(){K()}),window.addEventListener("keydown",Z)),a("hZAS5"),a("bMp0K"),a("4Z4PC");const z={btn:document.querySelector(".scrollBtn"),show(){this.btn.classList.remove("scrollBtn-hide")},hide(){this.btn.classList.add("scrollBtn-hide")},addEventListener(){this.btn&&(window.addEventListener("scroll",()=>{let e=window.scrollY||document.documentElement.scrollTop;e>100?this.show():this.hide()}),this.btn.onclick=()=>{window.scrollTo({top:0,behavior:"smooth"})})}};z.addEventListener(),a("fPeBo"),a("bXRWl"),a("bMZn5"),a("7uG5A");
//# sourceMappingURL=group.c469c6c7.js.map
