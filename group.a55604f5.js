function e(e,t,o,n){Object.defineProperty(e,t,{get:o,set:n,enumerable:!0,configurable:!0})}function t(e){return e&&e.__esModule?e.default:e}var o="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:"undefined"!=typeof window?window:"undefined"!=typeof global?global:{},n={},r={},a=o.parcelRequire9432;null==a&&((a=function(e){if(e in n)return n[e].exports;if(e in r){var t=r[e];delete r[e];var o={id:e,exports:{}};return n[e]=o,t.call(o.exports,o,o.exports),o.exports}var a=Error("Cannot find module '"+e+"'");throw a.code="MODULE_NOT_FOUND",a}).register=function(e,t){r[e]=t},o.parcelRequire9432=a),a.register("kyEFX",function(t,o){"use strict";e(t.exports,"register",function(){return n},function(e){return n=e}),e(t.exports,"resolve",function(){return r},function(e){return r=e});var n,r,a={};n=function(e){for(var t=Object.keys(e),o=0;o<t.length;o++)a[t[o]]=e[t[o]]},r=function(e){var t=a[e];if(null==t)throw Error("Could not resolve bundle with id "+e);return t}}),a("kyEFX").register(JSON.parse('{"5ZPII":"group.a55604f5.js","kRCxU":"amazon-icon1x.985b1de5.png","45Fu3":"amazon-icon2x.b774c146.png","3SUJU":"applebook-icon1x.a9f158e0.png","igZ6H":"applebook-icon2x.7ba433f7.png","YfQvy":"bookshop-icon1x.95f5821d.png","5pNEw":"bookshop-icon2x.2b4b4a60.png","2XmG8":"group.53a2e74c.js","9z8Um":"group.31d8c625.js"}')),a("3L4y6"),a("bUb57"),a("4R95q");var l=(a("3L4y6"),a("3L4y6"));const i=document.querySelector(".books-gallery"),s=new l.APIService;async function c(e){let t=await s.fetchBooksByCategory(e),o=await t.data;console.log(o),i.innerHTML=`<h1 class="collection-title">Books</h1>
  ...
  `;p.innerHTML=e}p&&(b(),p?.addEventListener("click",onSeeMoreBtnClick));var l=a("3L4y6"),h={};h=new URL(a("kyEFX").resolve("kRCxU"),import.meta.url).toString();var v={};v=new URL(a("kyEFX").resolve("45Fu3"),import.meta.url).toString();var S={};S=new URL(a("kyEFX").resolve("3SUJU"),import.meta.url).toString();var w={};w=new URL(a("kyEFX").resolve("igZ6H"),import.meta.url).toString();var _={};_=new URL(a("kyEFX").resolve("YfQvy"),import.meta.url).toString();var L={};L=new URL(a("kyEFX").resolve("5pNEw"),import.meta.url).toString();const E=document.querySelector("#allModal"),$=document.querySelector(".books-gallery"),x=document.querySelector(".add-storage-button"),H=document.querySelector(".remove-storage-btn"),q=document.querySelector(".storage-info"),F=new l.APIService,R="storage-data";let A=[],B={};$&&(x.addEventListener("click",function(){let e=JSON.parse(localStorage.getItem(R)),t=B;e&&0!==e.length?(e.push(t),localStorage.setItem(R,JSON.stringify(e))):(A.push(t),localStorage.setItem(R,JSON.stringify(A))),q.textContent="Сongratulations! You have added the book to the shopping list. To delete, press the button “Remove from the shopping list”.",T()}),H.addEventListener("click",function(){q.textContent="";let e=B.id,t=JSON.parse(localStorage.getItem(R)),o=t.findIndex(t=>t.id===e);t.splice(o,1),localStorage.setItem(R,JSON.stringify(t)),T()}),$.addEventListener("click",function(e){if("BUTTON"===e.target.nodeName||"UL"===e.target.nodeName||"DIV"===e.target.nodeName||"H3"===e.target.nodeName)return;let t=e.target.closest("li").id;U.classList.remove("is-hidden"),I.classList.remove("is-hidden"),N(t)}));const U=document.querySelector(".about-book-modal"),I=document.querySelector(".card-backdrop-modal");async function N(e){E.innerHTML="";try{let o=await O(e);return T(),function(e){let o=e.book_image,n=e.title,r=e.author,a=e.buy_links[0].url,l=e.buy_links[1].url,i=e.buy_links[4].url,s=e.description,c=s;""===s&&(c="Unfortunately, a brief description of this book is currently unavailable. But let that not hinder you from opening its pages and immersing yourself in the unforgettable world it creates.");let d=`  
